...
- Якщо в резюме вказано два або більше суперечливих рівні англійської і немає чіткої ознаки, який із них актуальний, поверни english_level=null.
- Не обирай автоматично перше, останнє або найвище значення.
- У полі languages збережи всі прямо вказані варіанти рівня англійської.
