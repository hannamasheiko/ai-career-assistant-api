...
@pytest.mark.parametrize(
    ...
    [
        ...
        (Status.SAVED, Type.INTERVIEW_INVITATION, Direction.INCOMING, Status.RECRUITER_CONTACT),
        (Status.ANALYZED, Type.INTERVIEW_INVITATION, Direction.INCOMING, Status.RECRUITER_CONTACT),
        (Status.RESUME_SENT, Type.INTERVIEW_INVITATION, Direction.INCOMING, Status.RECRUITER_CONTACT),
        (Status.SCREENING, Type.INTERVIEW_INVITATION, Direction.INCOMING, Status.SCREENING),
        (Status.SAVED, Type.INTERVIEW_INVITATION, Direction.OUTGOING, Status.SAVED),
        (Status.SAVED, Type.SCREENING_QUESTIONS, Direction.INCOMING, Status.SCREENING),
        (Status.ANALYZED, Type.SCREENING_QUESTIONS, Direction.INCOMING, Status.SCREENING),
        (Status.RESUME_SENT, Type.SCREENING_QUESTIONS, Direction.INCOMING, Status.SCREENING),
        (Status.INTERVIEW, Type.SCREENING_QUESTIONS, Direction.INCOMING, Status.INTERVIEW),
        (Status.SAVED, Type.TEST_TASK, Direction.INCOMING, Status.TEST_TASK),
        (Status.ANALYZED, Type.TEST_TASK, Direction.INCOMING, Status.TEST_TASK),
        (Status.SAVED, Type.TEST_TASK, Direction.OUTGOING, Status.SAVED),
